...
#define _print_mat(a)                                                                                                                     \
    lprintf(                                                                                                                              \
        "TEST", 1,                                                                                                                        \
        "(%3.5f,%3.5f,%3.5f)\n(%3.5f,%3.5f,%3.5f)\n(%3.5f,%3.5f,%3.5f)\n(%3.5f,%3.5f,%3.5f)\n(%3.5f,%3.5f,%3.5f)\n(%3.5f,%3.5f,%3.5f)\n", \
        creal((a).c[0]), creal((a).c[1]), creal((a).c[2]), creal((a).c[3]), creal((a).c[4]), creal((a).c[5]), creal((a).c[6]),            \
        creal((a).c[7]), creal((a).c[8]), cimag((a).c[0]), cimag((a).c[1]), cimag((a).c[2]), cimag((a).c[3]), cimag((a).c[4]),            \
        cimag((a).c[5]), cimag((a).c[6]), cimag((a).c[7]), cimag((a).c[8]))
        ...
        for (int x = 0; x < X; x++) {
            for (int y = 0; y < Y; y++) {
                for (int z = 0; z < Z; z++) {
                    ...
                    if (ix != iz) {
                        lprintf("ERROR", 1, "ipt and iup incompatible: [%d,%d,%d,%d] ix=%d iz=%d dir=%d\n", T, x, y, z, ix, iz,
                                0);
                    }
                    errors += err;
                    ...
                    if (err) { lprintf("ERROR", 1, "U not unit @ [%d,%d,%d,%d] ix=%d dir=%d\n", -1, x, y, z, ix, 0); }
                    if (ix != iz) {
                        lprintf("ERROR", 1, "ipt and idn incompatible: [%d,%d,%d,%d] ix=%d iz=%d dir=%d\n", -1, x, y, z, ix, iz,
                                0);
                    }
                    errors += err;
                }
