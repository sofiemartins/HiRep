    ...
    for (int n = 0; n < numsources; n++) {
        ...
        for (int t = 0; t < GLB_T; t++) {
            ...
            Rhostoch[t] +=
                ...
                (6 * numsources);
            Rhostoch[t] -=
                (mo_arr[8]->corr_re[corr_ind(0, 0, 0, 0, t, 1, 0)] + I * mo_arr[8]->corr_im[corr_ind(0, 0, 0, 0, t, 1, 0)]) /
                (6 * numsources); // there is an i in the interpolating field
            Rhostoch[t] +=
                (mo_arr[12]->corr_re[corr_ind(0, 0, 0, 0, t, 1, 0)] + I * mo_arr[12]->corr_im[corr_ind(0, 0, 0, 0, t, 1, 0)]) /
                (6 * numsources);
            Rhostoch[t] +=
                (mo_arr[13]->corr_re[corr_ind(0, 0, 0, 0, t, 1, 0)] + I * mo_arr[13]->corr_im[corr_ind(0, 0, 0, 0, t, 1, 0)]) /
                (6 * numsources);
            Rhostoch[t] -=
                (mo_arr[17]->corr_re[corr_ind(0, 0, 0, 0, t, 1, 0)] + I * mo_arr[17]->corr_im[corr_ind(0, 0, 0, 0, t, 1, 0)]) /
                (6 * numsources); // there is an i in the interpolating field
            Rhostoch[t] +=
                (mo_arr[21]->corr_re[corr_ind(0, 0, 0, 0, t, 1, 0)] + I * mo_arr[21]->corr_im[corr_ind(0, 0, 0, 0, t, 1, 0)]) /
                (6 * numsources);
        }
        for (int i = 0; i < ncorr; i++) {
            reset_mo(mo_arr[i]);
