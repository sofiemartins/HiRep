...
double avr_plaquette_cpu(suNg_field *gauge) {
    static double pa = 0.;
...
void full_plaquette_cpu(suNg_field *gauge) {
...
double (*avr_plaquette)(suNg_field *gauge) = avr_plaquette_cpu;
void (*full_plaquette)(suNg_field *gauge) = full_plaquette_cpu;
